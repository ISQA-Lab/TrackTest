...
def generate_cut_in(
    ...
    print(f"T1={T1}, point_count={point_count}, save_distance={save_distance}, init_road_idx={init_road_idx}")
    ...
    for i in range(1, point_count):
        ...
        if i < T1 - 1:
            ...
            _add_heading_constraint(s, vx2, vy2, der, curve_mode)
            _add_order_constraint(s, cur_pos, init_lane_cars, init_point, i, save_distance, forward_sign)
            _add_order_constraint(s, cur_pos, target_lane_cars, cut_in_point, i, save_distance, forward_sign)
        elif i == T1:
            _add_order_constraint(s, cur_pos, target_lane_cars, cut_in_point, i, save_distance, forward_sign)
        else:
