...
def generate_lead(
    ...
    ref_line0 = init_ref_line if init_ref_line is not None else keep_ref_line
    axis0 = x0 if curve_mode == "y_of_x" else y0
    der0 = _get_derivative(getderivative, axis0, ref_line0)
    ...
    for i in range(1, point_count):
        ...
        der = _get_derivative(getderivative, axis_value, keep_ref_line)
