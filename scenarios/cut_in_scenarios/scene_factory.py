...
def _scene_1(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "path_name_template": "{seq}_cut_in_{uid}",
        },
    }
...
def _scene_14(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "path_name_template": "14_cutin_{uid}",
        },
    }
...
def _scene_18(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "speed_limit": 25,
            "seconds_range": (3, 8),
            "save_distance_range": (30, 40),
            "init_ref_line": roadline2,
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "path_name_template": "18_cutin_{uid}",
        },
    }
...
def build_cut_in_scene(seq, script_dir):
    if seq not in _SCENE_BUILDERS:
        raise ValueError(f"Unsupported cut_in scene: {seq}")
