...
def _scene_1(script_dir):
    ...
    ego_path = pickle.load(open(os.path.join(script_dir, "data/egos__0001_ego_trajectory.pkl"), "rb"))
    back0 = pickle.load(open(os.path.join(script_dir, "data/npc_1_linux__0__generates__npc_0.pkl"), "rb"))
    back1 = pickle.load(open(os.path.join(script_dir, "data/npc_1_linux__0__generates__npc_1.pkl"), "rb"))
    ...
    return {
        ...
        "config": {
            ...
            "pre_ref_line": roadline_middle,
            "post_ref_line": roadline_middle,
...
def _scene_2(script_dir):
    from z3 import And
    from curves.curve_2 import roadline2, roadline3, roadline1, getderivative, getvalue

    seq = 2
    frame_start = 0
    ego = pickle.load(open(os.path.join(script_dir, "data/egos__2_ego_trajectory.pkl"), "rb"))[0:43]
    back0 = pickle.load(open("data/with_npc__1__generates__npc_0.pkl", "rb"))[0:43]
    back1 = pickle.load(open("data/with_npc__1__generates__npc_1.pkl", "rb"))[0:43]
    ...
    return {
        ...
        "ego_idx": 1,
        "npcs": [
            "data/with_npc__1__final__1_npc0_2_0_43_-1_1.npy",
            "data/with_npc__1__final__1_npc1_2_0_43_-1_1.npy",
        ],
        "getderivative": getderivative,
        "config": {
            "curve_mode": "y_of_x",
            ...
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "extra_axis_constraints": [("y", -1)],
            "path_name_template": "2_cut_out2_{uid}",
        },
    }
...
def _scene_3(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "pre_ref_line": roadline3,
            "post_ref_line": roadline1,
            "path_name_template": "{seq}_cut_out_{uid}",
        },
    }
...
def _scene_8(script_dir):
    from curves.curve_8 import roadline2, roadline3, getderivative, on_upper_lane_relaxed, on_middle_lane_relaxed, on_lower_lane_relaxed
...
def _scene_13(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "path_name_template": "13_cutout_{uid}",
        },
    }
...
def _scene_14(script_dir):
    from z3 import And
    from curves.curve_14 import roadline2, roadline4, roadline1, getderivative, getvalue
    ...
    return {
        ...
        "config": {
            ...
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "path_name_template": "14_cutout_{uid}",
        },
    }
...
def _scene_18(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "speed_limit": 25,
            "seconds_range": (3, 8),
            "save_distance_range": (35, 40),
            "init_ref_line": roadline1,
            "pre_ref_line": roadline2,
            "post_ref_line": roadline2,
            "path_name_template": "18_cutout_{uid}",
        },
    }
...
def build_cut_out_scene(seq, script_dir):
    if seq not in _SCENE_BUILDERS:
        raise ValueError(f"Unsupported cut_out scene: {seq}")
