...
def _scene_3(script_dir):
    from curves.curve_3 import roadline2, getderivative, on_upper_lane_relaxed, on_lower_lane_relaxed
...
def _scene_4(script_dir):
    from curves.curve_4 import roadline2, getderivative, on_upper_lane_relaxed, on_lower_lane_relaxed
...
def _scene_13(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "ref_line": roadline2,
            "post_sin_axis": "x",
            "post_sin_amplitude": 2.0,
            "post_sin_frequency": 1.0,
            "post_sin_random_phase": True,
            "path_name_template": "{seq}_side_by_side_{uid}",
        },
    }
...
def _scene_18(script_dir):
    ...
    return {
        ...
        "config": {
            ...
            "speed_limit": 50,
            "seconds_range": (4, 5),
            "save_distance_range": (10, 25),
            "offset_min": 10,
            "offset_max": 40,
            "oscillation_amplitude": 0,
            "oscillation_frequency": 1.0,
            "ref_line": roadline2,
            "path_name_template": "18_sidebyside_{uid}",
        },
    }
...
def build_side_by_side_scene(seq, script_dir):
    if seq not in _SCENE_BUILDERS:
        raise ValueError(f"Unsupported side_by_side scene: {seq}")
