...
from common.cut_in_common import generate_cut_in
from scenarios.cut_in_scenarios import build_cut_in_scene
...
def main():
    parser = argparse.ArgumentParser(description="Unified cut_in entry")
    ...
    parser.add_argument("--start_road_idx", type=int, default=None, help="Override init lane index (useful for seq=18)")
